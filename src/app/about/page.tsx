        ...
        <div className="mt-4">
          <ul className="flex flex-wrap items-center justify-center gap-6 w-full text-lg text-neutral-400">
            <li
              ...
              className={clsx(skill === 'HTML' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                HTML
            </li>
            <li
              onClick={() => setSkill('CSS')} 
              className={clsx(skill === 'CSS' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                CSS
            </li>
            <li
              onClick={() => setSkill('Javascript')} 
              className={clsx(skill === 'Javascript' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                Javascript
            </li>
            <li
              onClick={() => setSkill('Next js')} 
              className={clsx(skill === 'Next js' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                Next js
            </li>
            <li
              onClick={() => setSkill('Node js')} 
              className={clsx(skill === 'Node js' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                Node js
            </li>
            <li
              onClick={() => setSkill('React js')} 
              className={clsx(skill === 'React js' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                React js
            </li>

            <li
              onClick={() => setSkill('SQL')} 
              className={clsx(skill === 'SQL' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                SQL
            </li>
            <li
              onClick={() => setSkill('Typescript')} 
              className={clsx(skill === 'Typescript' && 'text-cyan-500', 'cursor-pointer hover:text-cyan-500 transition-colors')}>
                Typescript
            </li>
          </ul>
